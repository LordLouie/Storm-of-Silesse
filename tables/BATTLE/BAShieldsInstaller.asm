      aBattleAnimationShieldClassTable .block
        ...
        _LanceKnightShields .block
          .structBattleAnimationShieldEntry	Seadna,		Shield_LanceKnight,	BA_ShieldPalette_BaseFinn
        ...
        _DukeKnightShields .block
          .structBattleAnimationShieldEntry	Seadna,		Shield_DukeKnight,	BA_ShieldPalette_PromotedFinn
