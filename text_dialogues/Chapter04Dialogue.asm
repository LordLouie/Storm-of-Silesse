...
.word LoadPortrait
.word fergus_portrait
.text "Well, well! Hey, Prince Neill, somebody's come"
.byte NewLine
...
.byte NewLine
.text "Prince Neill is the one we need to worry about."
.byte WaitForA
.byte ScrollText
...
.text "Now in Raydrik's clutches, Neill was detained"
.byte NewLine
...
.text "Neill would now see firsthand what kind"
.byte NewLine
