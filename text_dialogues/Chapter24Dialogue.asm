...
.byte NewLine
.text "Commander Gerald rescued me soon after."
.byte WaitForA
.byte ScrollText
...
.text "We're certainly in for a difficult battle,"
.byte NewLine
.text "Prince Neill, but remember: you're not alone."
.byte WaitForA
.byte ScrollText
...
.byte NewLine
.text "Now that Gerald's rescue is within our grasp,"
.byte NewLine
...
.byte NewLine
.text "Don't forget the staff, Lord Neill!"
.byte WaitForA
...
.word $0705 ;y then x
.byte NewLine
.text "Neill finally stood before the gates"
.byte WaitForA
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "Once, Neill had fled these very walls"
.byte NewLine
