...
.byte Right_slot
.byte ScrollText
.text "Gerald... Things are very different now"
.byte NewLine
...
.text "Of course!"
.byte NewLine
.text "There's so much I want to tell you, Gerald..."
.byte WaitForA
...
.byte NewLine
.text "secret temple. Stay alert, Prince Neill!"
.byte WaitForA
...
.byte WaitForA
.byte ScrollText
.text "After we've rescued Lady Gerald,"
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "Gerald... I realized I never thanked you."
.byte NewLine
...
.byte NewLine
.text "you had to scold me, Gerald?"
.byte WaitForA
.byte ScrollText
...
.byte NewLine
.text "Seadna was my father, you were my mother,"
.byte NewLine
...
.byte NewLine
.text "my own age, like Otto and Barra."
.byte WaitForA
.byte ScrollText
...
.byte WaitForA
.byte ScrollText
.text "I have you to thank for all that, Gerald."
.byte WaitForA
.byte NewLine
...
.byte NewLine
.text "with Seadna, who was hurt so badly he could"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "You just keep watching out for Little Neill."
.byte NewLine
...
.text "It's good to have ya back, Gerald."
.byte NewLine
...
.byte Right_slot
.text "You don't give yourself enough credit, Edith."
.byte WaitForA
.byte NewLine
...
.text "Commander... It wasn't just Lord Neill."
.byte NewLine
...
.byte NewLine
.text "somebody like Barra."
.byte WaitForA
.byte ScrollText
.text "Otto... Take good care of your father"
.byte NewLine
...
.word LoadPortrait
.word finn_portrait
.text "Gerald... I regret I couldn't do more for you,"
.byte NewLine
...
.byte Right_slot
.text "And I'm grateful to you, Seadna, for everything"
.byte NewLine
...
.text "Just like me...?"
.byte NewLine
.text "Are you sure you're not just confused, Seadna?"
.byte WaitForA
...
.text "Brigid...?"
.byte NewLine
.text "Seadna, are you saying that woman... was me?"
.byte WaitForA
...
.text "Heh..."
.byte NewLine
.text "I never took you for a romantic, Seadna."
.byte WaitForA
.byte ScrollText
...
.byte WaitForA
.byte ScrollText
.text "You've got the wrong person, Seadna."
.byte NewLine
.text "I'm just an ordinary sellsword, making my way"
.byte NewLine
.text "from place to place... I'm Gerald of Fiana."
.byte WaitForA
