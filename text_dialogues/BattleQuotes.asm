...
.text "Watch out! Ye don't wanna see"
.byte NewLine
.text "what this beast is capable of"
.byte NewLine
.text "when he's cornered!"
.byte WaitForA
.byte EndText
...
.text "Ack, an ambush!"
.byte NewLine
.text "Protect the cargo!"
.byte NewLine
.text "They mustn't see what's inside-!"
.byte WaitForA
.byte EndText

dialogueEdithBattleQuote
.text "This is the sort I'm supposed"
.byte NewLine
.text "to fight off?"
.byte NewLine
.text "Tch, go figure..."
...
dialogueFachtnaBattleQuote
.text "Come, face your death!"
.byte WaitForA
.byte EndText
...
dialogueAgnesBattleQuote
.text "I'll make it quick."
.byte NewLine
.text "May Loptous rest your soul..."
.byte WaitForA
.byte EndText
