...
.byte NewLine
.text "Lord Neill! I'll be waitin' for you just up ahead!"
.byte WaitForA
.byte EndText
...
.byte NewLine
.text "Prince Neill! C'mon, let's go!"
.byte WaitForA
.byte EndText
...
.byte NewLine
.text "Prince Neill! Please, hurry!"
.byte WaitForA
.byte EndText
...
.text "Forgive me for leaving your side, Prince Neill!"
.byte NewLine
.text "I'll ride ahead!"
.byte WaitForA
.byte EndText
...
.text "Luck be with you, Prince Neill!"
.byte WaitForA
.byte EndText
...
.byte NewLine
.text "Please come quickly, Lord Neill."
.byte WaitForA
.byte EndText