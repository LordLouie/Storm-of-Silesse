...
.byte Left_slot
.byte ScrollText
.text "Prince Neill needs men like you, Xavier."
.byte NewLine
...
.byte NewLine
.text "have been dealt with, Prince Neill."
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "You owe me nothing, Prince Neill."
.byte WaitForA
...
.byte WaitForA
.byte NewLine
.text "Thank you for everything, Seadna."
.byte WaitForA
...
.byte Right_slot
.text "Princess Matar? Ah, I haven't"
.byte NewLine
...
.word LoadPortrait
.word oldlady3_portrait
.text "You're Prince Neill, right?"
.byte NewLine
...
.byte NewLine
.text "Lord Neill, you're the only hope for our people!"
.byte WaitForA
...
.word LoadPortrait
.word dorius_portrait
.text "Prince Neill, we should discuss this!"
.byte NewLine
...
.byte NewLine
.text "all your intellect, to Prince Neill's cause."
.byte WaitForA
...
.byte NewLine
.text "but my fight isn't over until I rescue Gerald."
.byte WaitForA
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "The kingdom's rebirth—Neill's greatest desire—"
.byte NewLine
