...
.text "Ah, I see..."
.byte NewLine
.text "That must be the wayward Prince Neill!"
.byte WaitForA
.byte ScrollText
.text "First Olwen, and now Prince Neill marches"
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "...It's Neill. Neill of House Leonster."
.byte WaitForA
...
.byte WaitForA
.byte ScrollText
.text "Well, Lord Neill, I believe we'll meet again"
.byte NewLine
