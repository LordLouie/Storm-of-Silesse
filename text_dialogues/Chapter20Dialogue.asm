...
.word LoadPortrait
.word augustus_portrait
.text "Prince Neill, the enemy is retreating!"
.byte WaitForA
...
.text "So we meet at last, Prince Neill."
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "No, Lord Neill, it's not your fault."
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "Lord Neill, this is a letter from Lord Seliph."
.byte NewLine
...
.byte Left_slot
.text "Prince Neill, I have a request, if I may."
.byte NewLine
...
.word LoadPortrait
.word augustus_portrait
.text "Prince Neill, the Friege army"
.byte NewLine
...
.word $0013 ;y then x
.text "Neill's Liberation Army has fought well,"
.byte NewLine
