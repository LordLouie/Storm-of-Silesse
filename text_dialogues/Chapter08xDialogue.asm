...
.byte NewLine
.text "Otto, always ready to kill the mood..."
.byte WaitForA
.byte ScrollText
...
.byte NewLine
.text "to be makin' excuses, Edith!"
.byte WaitForA
.byte ScrollText
...
.byte NewLine
.text "wench Gerald cheat you outta the good land!"
.byte NewLine
...
.word LoadPortrait
.word leif_portrait2
.text "I pity Edith and his men, truly, but..."
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "Edith's men, abandoned in their youth,"
.byte NewLine
