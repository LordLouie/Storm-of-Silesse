...
.byte Left_slot
.byte ScrollText
.text "I was rescued by Prince Neill, and at my"
.byte NewLine
...
.byte NewLine
.text "is part of Prince Neill's Liberation Army!"
.byte NewLine
...
.byte WaitForA
.byte NewLine
.text "Serve Prince Neill as you would serve me!"
.byte WaitForA
.byte ScrollText
...
.byte WaitForA
.byte ScrollText
.text "So orders Her Highness Princess Matar,"
.byte NewLine
...
.byte NewLine
.text "Prince Neill of the Liberation Army"
.byte NewLine
...
.word LoadPortrait
.word augustus_portrait
.text "Prince Neill, time is of the essence."
.byte NewLine
...
.word $0B0E ;y then x
.byte NewLine
.text "Neill's forces were finally rested and ready."
.byte WaitForA
.byte ScrollText
...
.text "It was this moment that marked Neill's"
.byte NewLine
