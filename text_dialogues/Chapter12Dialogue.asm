...
.text "Dawn is breaking, Prince Neill!"
.byte NewLine
...
.byte NewLine
.text "You said her name was Fee, right?"
.byte WaitForA
.byte ScrollText
...
.byte NewLine
.text "I'm the daughter of Gerald of Fiana!"
.byte WaitForA
.byte ScrollText
...
.byte WaitForA
.byte ScrollText
.text "Please, Neill, I want to be a part of this!"
.byte NewLine
...
.word $0512 ;y then x
.text "Neill's Liberation Army was keenly aware"
.byte WaitForA
.byte NewLine
