...
.text "Prince Neill! Oh, it's been too long, milord!"
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "Prince Neill... This halfway feels like a dream..."
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "I'm sure you'll find her someday, Prince Neill."
.byte NewLine
...
.word LoadPortrait
.word selphina_portrait
.text "Sir Seadna! It's been too long."
.byte WaitForA
...
.byte Right_slot
.byte ScrollText
.text "Have you forgotten me already, Sir Seadna?"
.byte NewLine
.text "It's Selphina!"
.byte WaitForA
...
.byte Right_slot
.byte ScrollText
.text "No, I know you understand, Sir Seadna—"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "I want only to aid Prince Neill,"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "According to him, Prince Neill and a coalition"
.byte NewLine
...
.text "The villa is just ahead, Prince Neill."
.byte WaitForA
...
.byte NewLine
.text "Prince Neill—that's the Thracian army!"
.byte WaitForA
...
.byte NewLine
.text "and Seadna. Without your sacrifices,"
.byte NewLine
...
.byte NewLine
.text "upon your heart, Prince Neill."
.byte WaitForA
.byte ScrollText
...
.byte NewLine
.text "at this strange state of affairs, Prince Neill."
.byte WaitForA
...
.word LoadPortrait
.word dorias_portrait
.text "Hmm... Prince Neill's man was right."
.byte NewLine
...
.word LoadPortrait
.word augustus_portrait
.text "Prince Neill, I've dire news!"
.byte NewLine
...
.word $0411 ;y then x
.text "Neill's army now sought to join"
.byte NewLine
...
.text "Neill set a course for General Hannibal's"
.byte NewLine
.text "mountain villa, "
.byte WaitForA
.word LoadPortraitalt_1
