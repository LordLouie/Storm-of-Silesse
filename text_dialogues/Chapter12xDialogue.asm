...
.byte WaitForA
.byte ScrollText
.text "This is Prince Neill's Liberation Army,"
.byte NewLine
...
.byte Right_slot
.byte ScrollText
.text "Prince Neill an' the whole North Thracian"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "Say, I saw that Lord Neill fella fightin' earlier..."
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "Lord Neill, please, you've got to let me"
.byte NewLine
