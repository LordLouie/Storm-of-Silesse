...
.byte NewLine
.text "What is Lord Neill doing now?"
.byte WaitForA
...
.byte NewLine
.text "about Prince Neill's location."
.byte WaitForA
.byte ScrollText
...
.byte Left_slot
.byte ScrollText
.text "What will become of Lord Neill"
.byte NewLine
...
.byte NewLine
.text "I shall accompany Lord Neill."
.byte WaitForA
.byte ScrollText
...
.byte NewLine
.text "of Lord Neill and myself, I'll return home."
.byte WaitForA
.byte ScrollText
...
.byte Right_slot
.byte ScrollText
.text "Is Prince Neill worthy of such confidence,"
.byte NewLine
