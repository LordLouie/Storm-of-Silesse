...
.byte NewLine
.text "of Belhalla, Neill went on"
.byte NewLine
...
.byte NewLine
.text "that Neill had safely taken"
.byte NewLine
.text "the throne, Seadna suddenly"
.byte NewLine
.text "disappeared."
.word PauseDialogue
.byte $5A
...
.word $1200
.byte $04
.text "After Gerald departed"
.byte NewLine
.text "Fiana, Barra took up"
.byte NewLine
...
.byte NewLine
.text "a time, Gerald temporarily"
.byte NewLine
...
.byte NewLine
.text "it is said that Neill and"
.byte NewLine
...
.byte NewLine
.text "Neill and Altena to a post"
.byte NewLine
...
.byte NewLine
.text "experience in Neill's army,"
.byte NewLine
