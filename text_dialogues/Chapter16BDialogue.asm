...
.byte NewLine
.text "I'm Matar of Ulster!"
.byte WaitForA

.byte Right_slot
.byte ScrollText
.text "Matar... The princess? Princess of Ulster?"
.byte NewLine
...
.word LoadPortrait
.word dorius_portrait
.text "...Princess Matar, I must beg to differ."
.byte WaitForA
.byte ScrollText
.text "The Empire planned to conquer Ulster"
.byte NewLine
.text "all along. Prince Neill's presence was merely"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "Shifting the blame to Prince Neill"
.byte NewLine
...
.byte Right_slot
.byte ScrollText
.text "Prince Neill, if you weren't lying"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "I know you're Prince Neill of House Leonster,"
.byte NewLine
.text "son of Quan."
.byte WaitForA
.byte ScrollText
...
.byte NewLine
.text "trying to rescue his precious Princess Matar."
.byte WaitForA
...
.word $0C1A ;y then x
.text "Neill approached Leonster from the south."
.byte WaitForA
...
.word $0168 ;rinecoch
.word $0419 ;y then x
.text "Neill would soon learn first-hand how the area"
.byte NewLine
