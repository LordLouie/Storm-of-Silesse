...
dialogueChapter17ASaiasTrottier
...
.byte NewLine
.text "Colonel Trottier has, uh... He's already..."
.byte WaitForA
...
.byte NewLine
.text "Prince Neill, we cannot hesitate for even"
.byte NewLine
...
.byte NewLine
.text "Trottier. Explain yourself!"
.byte WaitForA
...
.text "Very well."
.byte NewLine
.text "I'm counting on you, Trottier!"
.byte WaitForA
...
.byte NewLine
.text "Don't let your guard down, Prince Neill."
.byte WaitForA
...
.word LoadPortrait
.word dorius_portrait
.text "Prince Neill, we've captured the commander"
.byte NewLine
