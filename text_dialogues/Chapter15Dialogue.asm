...
.byte WaitForA
.byte ScrollText
.text "Very well, Ilse, I'll do as you say."
.byte NewLine
...
.text "H-How...?!"
.byte NewLine
.text "Are you THE Neill, the prince?"
.byte WaitForA
.byte ScrollText
.text "Talk about being in the right place"
.byte NewLine
.text "at the right time! See, I'm Ilse, an' I'm"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "Ilse, my greatest desire is to free every"
.byte NewLine
...
.text "Prince Neill, a moment, if I may?"
.byte WaitForA
...
.byte WaitForA
.byte NewLine
.text "The decision rests with Prince Neill now."
.byte WaitForA
...
.word $070F ;y then x
.text "However, Neill would soon have to make"
.byte NewLine
