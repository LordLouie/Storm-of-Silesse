...
dialogueChapter02xOpening1
  ...
  .word lifis_portrait
	...
	.byte NewLine
	.text "Fee. We both know I could get"
	.byte NewLine
...
dialogueChapter02xEnding1
	...
	.byte Right_slot
	.byte ScrollText
	.text "Have you forgotten me already, Lord Neill?"
	.byte NewLine
	.text "It's me, Fee—we met in Tahra."
	.byte WaitForA

	.byte Left_slot
	.byte ScrollText
	.text "Fee, you say? I knew a young woman"
	.byte NewLine
	...
	.byte NewLine
	.text "Let's be off, Fee."
	.byte WaitForA

	.byte Right_slot
	.byte ScrollText
	.text "You will be most welcome in Tahra, Lord Neill."
	.byte NewLine
	.text "Thank you."
	.byte WaitForA
...
.word LoadPortrait
.word safie_portrait
.text "...Lord Neill, Lifis is not an evil man."
.byte WaitForA
.byte ScrollText
...
.byte Left_slot
.text "...All right. If Fee believes in you,"
.byte NewLine
...
.byte NewLine
.text "Either way, it'll have to wait until after Fee"
.byte NewLine
