...
.byte Left_slot
.byte ScrollText
.text "...My name is Neill, and I command this army."
.byte WaitForA
...
.text "Neill?!"
.byte NewLine
.text "So you're Prince Neill of House Leonster,"
.byte NewLine
.text "are you not?"
.byte WaitForA
.byte ScrollText
...
.byte WaitForA
.byte ScrollText
.text "Prince Neill, if you can forgive"
.byte NewLine
...
.byte NewLine
.text "in Prince Neill's army."
.byte WaitForA

.byte Right_slot
.byte ScrollText
.text "Join Prince Neill?!"
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "...I met Prince Neill, albeit briefly. Just from"
.byte NewLine
...
.byte Right_slot
.byte ScrollText
.text "...If you're that convinced of Prince Neill's"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "They seem to be led by Neill, the rebel prince"
.byte NewLine
