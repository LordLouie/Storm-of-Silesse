...
.byte Right_slot
.text "Seadna! It feels like a lifetime since last we met..."
.byte NewLine
...
.byte NewLine
.text "Prince Neill? You've done well, old friend."
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "Were it not for their aid, I fear Lord Neill"
.byte NewLine
...
.byte NewLine
.text "and you to protect Prince Neill."
.byte NewLine
...
.byte NewLine
.text "that Prince Neill and his retinue make it"
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "Of course! Prince Neill heard that Tahra"
.byte NewLine
...
.byte NewLine
.text "to have left Prince Neill behind?"
.byte WaitForA
...
.byte WaitForA
.byte ScrollText
.text "I remember that when Prince Neill was still"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "This is indeed Prince Neill, in the flesh—"
.byte NewLine
...
.byte Right_slot
.byte ScrollText
.text "Prince Neill... Long have we mourned the"
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "Lord Neill! I... I can scarcely believe my eyes!"
.byte NewLine
...
.text "Dacia Forest, "
.byte WaitForA
.text "Neill found a most welcome"
.byte NewLine
