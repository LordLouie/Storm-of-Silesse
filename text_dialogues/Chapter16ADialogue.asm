...
.byte NewLine
.text "Gods be with you, Lord Neill."
.byte WaitForA
...
.byte NewLine
.text "That goes against Colonel Trottier's orders!"
.byte WaitForA
...
.byte NewLine
.text "Besides, Trottier is nothing! Nobody!"
.byte NewLine
...
.text "Ah, you must be Lord Neill!"
.byte WaitForA
...
.byte WaitForA
.byte ScrollText
.text "Prince Neill, if it pleases you,"
.byte NewLine
...
.byte Right_slot
.text "Leave everything to me, Colonel Trottier."
.byte WaitForA
.byte ScrollText
...
.byte NewLine
.text "Prince Neill leads their vanguard, and they're"
.byte NewLine
...
.word LoadPortrait
.word olwen_portrait
.text "Leave that task to me, Lord Neill."
.byte NewLine
...
.byte NewLine
.text "from Seadna's arms... At first, I didn't"
.byte NewLine
.text "understand what was happening."
.byte WaitForA
.byte ScrollText
.text "But when I saw the look on Seadna's face,"
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "I forced Seadna into a tough role, I admit."
.byte NewLine
...
.byte Right_slot
.byte ScrollText
.text "That was the last time I ever saw Seadna cry."
.byte NewLine
...
.word $090D ;y then x
.text "Neill made for Leonster by way of the coast."
.byte WaitForA
.byte ScrollText
