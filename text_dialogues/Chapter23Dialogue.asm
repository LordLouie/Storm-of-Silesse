...
.byte NewLine
.text "for a whole year now, Prince Neill!"
.byte WaitForA
.byte ScrollText
...
.byte Right_slot
.byte ScrollText
.text "Hah! I was only joking, Prince Neill."
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "Prince Neill, will you lend me your strength"
.byte NewLine
...
.byte NewLine
.text "Gods be with you, Prince Neill!"
.byte WaitForA
...
.byte NewLine
.text "I take it you're Prince Neill?"
.byte WaitForA
...
.byte WaitForA
.byte ScrollText
.text "May we meet again, Lord Neill."
.byte WaitForA
...
.byte WaitForA
.byte ScrollText
.text "A rebel leader, Prince Neill, is marching"
.byte NewLine
...
.byte NewLine
.text "of Castle Munster are ours, Prince Neill."
.byte NewLine
...
.byte NewLine
.text "Prince Neill, you should be able to wield it."
.byte WaitForA
...
.word $020D ;y then x
.byte NewLine
.text "Neill approached Raydrik's stronghold,"
.byte NewLine
.text "Castle Munster."
.byte WaitForA
...
.text "There, emboldened by news of Neill's victory,"
.byte NewLine
