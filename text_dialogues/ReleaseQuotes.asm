...
dialogueWeissmannReleaseQuote
.text "Ah... sorry about causin' such a stir."
.byte NewLine
.text "I'll make myself scarce..."
.byte WaitForA
.byte EndText

dialogueBucksReleaseQuote
.text "I have buckled under the weight of shame."
.byte NewLine
.text "Letting me live only prolongs"
.byte NewLine
.text "my suffering..."
.byte WaitForA
.byte EndText

dialogueEdithReleaseQuote
.text "I'll just be on my merry way, then."
.byte NewLine
.text "Cheers!"
.byte WaitForA
.byte EndText
...
dialogueFachtnaReleaseQuote
.text "M-My knives! They were all I had!"
.byte NewLine
.text "I... I hate you! "
.byte WaitForA
.byte EndText
...
.byte NewLine
.text "I'm off to find my Big Sis, Fee, now."
.byte WaitForA
.byte EndText
