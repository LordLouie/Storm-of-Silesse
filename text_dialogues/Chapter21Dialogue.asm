...
.byte NewLine
.text "Er... I take it you're with Prince Neill?"
.byte NewLine
...
.byte Right_slot
.text "I wish we could keep talking, Prince Neill,"
.byte NewLine
...
.word LoadPortrait
.word julia_portrait
.text "I'll be praying for your health, Lord Neill..."
.byte WaitForA
.byte ScrollText
...
.text "The army stands ready, Prince Neill."
.byte NewLine
...
.byte NewLine
.text "Prince Neill. Besides, we have intelligence that"
.byte NewLine
...
.word $090E ;y then x
.text "By the time Neill had finished"
.byte NewLine
