...
.byte Left_slot
.byte ScrollText
.text "...Lady Gerald was turned to stone by some"
.byte NewLine
.text "foul magic, you say? If that is indeed the case,"
.byte NewLine
.text "you...must accept that she is gone, Prince Neill."
.byte WaitForA
...
.byte WaitForA
.byte ScrollText
.text "If true, I imagine Lady Gerald's petrified form"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "...Prince Neill, your loyalty to Lady Gerald"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "Prince Neill, you carry the blood of both"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "It would be nothing short of what Seadna and I"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "Though I must say, Prince Neill, I am gladdened"
.byte NewLine
...
.word LoadPortrait
.word ced_portrait
.text "Good! Prince Neill is still safe!"
.byte WaitForA
...
.byte NewLine
.text "like this, but Prince Neill must survive,"
.byte NewLine
...
.byte NewLine
.text "Prince Neill has made it clear of the castle."
.byte NewLine
.text "He's...escaped."
.byte WaitForA
...
dialogueChapter06SailaneScrollHouseLeenaDead
...
dialogueChapter06SailaneScrollHouseLeenaAlive
