...
.byte NewLine
.text "I'll claim Prince Neill's head"
.byte NewLine
...
.byte Right_slot
.byte ScrollText
.text "It is true that Prince Neill has brought"
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "Seadna... We've been through so many"
.byte NewLine
...
.byte NewLine
.text "I knew I could always rely on you, Seadna."
.byte WaitForA
.byte NewLine
...
.byte NewLine
.text "for you, Seadna. Of course I'll do as you ask!"
.byte NewLine
...
.byte NewLine
.text "Would that be enough to repay you, Seadna?"
.byte WaitForA

.byte Right_slot
.byte ScrollText
.text "It's...all I could have dreamed of, Lord Neill."
.byte WaitForA
.byte ScrollText
...
.byte Left_slot
.text "What?! You're not coming with me, Gerald?!"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "All right, Gerald, it's a deal:"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "I believe in you, Little Neill."
.byte NewLine
...
.text "Prince Neill, something's been on my mind"
.byte NewLine
...
.byte Right_slot
.byte ScrollText
.text "Of course I will, Lord Neill!"
.byte WaitForA
.byte ScrollText
...
.byte NewLine
.text "hurting both Prince Neill and my sworn lord"
.byte NewLine
...
.word LoadPortrait
.word augustus_portrait
.text "Prince Neill, Lord Seliph is here to see you."
.byte WaitForA
.byte ScrollText
.word LoadPortrait
...
.byte NewLine
.text "I'm relieved to see you safe, Prince Neill."
.byte WaitForA
...
.byte WaitForA
.byte ScrollText
.text "Prince Neill, will you continue"
.byte NewLine
