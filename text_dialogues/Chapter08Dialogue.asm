...
.word LoadPortrait
.word marty_portrait
.text "Calm down, Waulter, he ain't recognized you..."
.byte NewLine
...
.word LoadPortrait
.word osian_portrait
.text "Hm? Wait, you're... Hey, Waulter, ol' buddy!"
.byte WaitForA

.byte Right_slot
.byte ScrollText
.text "What? Waulter? Don't know no Waulter."
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "Waulter, pal, I could spot that chin of yours"
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "That isn't the problem here! C'mon, Waulter!"
.byte NewLine
.text "Raiding villages?! You think that's what"
.byte NewLine
.text "Edith would want? Or the Commander?"
.byte WaitForA
.byte ScrollText
...
.byte Left_slot
.byte ScrollText
.text "Argh! You should be ashamed, Waulter!"
.byte NewLine
...
.text "Hm? Is that... Waulter, is that you?"
.byte WaitForA
...
.byte Left_slot
.byte ScrollText
.text "Waulter, you're tall enough to be a lightning rod."
.byte NewLine
...
.byte NewLine
.text "Waulter! It's not enough that you're raiding"
.byte NewLine
...
.byte NewLine
.text "Edith and the Commander taught you?"
.byte WaitForA
.byte ScrollText
...
.text "While Edith was away helpin'"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "If it pleases you, Prince Neill, I want nothing"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "The bandits of this area—Edith's gang,"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "Still, this is most curious... This is Edith's"
.byte NewLine
...
.word LoadPortrait
.word augustus_portrait
.text "Prince Neill, I've brought the man"
.byte NewLine
...
.byte Right_slot
.byte ScrollText
.text "The lord of that manor, Edith,"
.byte NewLine
...
.word LoadPortrait
.word leif_portrait2
.text "Edith! You're all right!"
.byte WaitForA

.byte Right_slot
.text "Well, I'll be... Prince Neill!"
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "Gerald is...still in Munster. We...didn't have"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "It ain't like anybody can replace Gerald,"
.byte NewLine
...
.byte NewLine
.text "We'll get Gerald back—together."
.byte WaitForA
...
.byte Left_slot
.byte ScrollText
.text "Without Edith to keep them in line, look"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "...Do you understand, Prince Neill?"
.byte WaitForA
...
.word $0817 ;y then x
.byte NewLine
.text "Freeblades, Neill made his way west."
.byte WaitForA
.byte ScrollText
.word LoadPortraitalt_1
.long LoadPortraitalt_2
