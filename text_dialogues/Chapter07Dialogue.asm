...
.text "Prince Neill, the Knights of Munster"
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "I hear the ringleader is a young'un named Neill,"
.byte NewLine
...
.text "Prince Neill! Sheesh, some help I turned out"
.byte NewLine
...
.word LoadPortrait
.word ronan_portrait
.text "I'm awful sorry, Prince Neill..."
.byte NewLine
...
.word LoadPortrait
.word finn_portrait
.text "I must reach Lord Neill at once..."
.byte NewLine
...
.byte Left_slot
.text "Am I that much of a burden to you, Sir Seadna?"
.byte WaitForA
...
.byte WaitForA
.byte ScrollText
.text "If I can help Lord Neill—and in so doing, help"
.byte NewLine
.text "Tahra—then I must. We are both bound by duty,"
.byte NewLine
.text "Sir Seadna. Allow me to uphold my own oath."
.byte WaitForA
...
.word LoadPortrait
.word safie_portrait
.text "I pray that Lord Neill is safe..."
.byte WaitForA
...
.byte NewLine
.text "to protect Prince Neill, yes."
.byte WaitForA
...
.byte Left_slot
.byte ScrollText
.text "Losing Prince Neill, losing what he represents,"
.byte NewLine
...
.word LoadPortrait
.word finn_portrait
.text "Lord Neill! You're all right!"
.byte WaitForA

.byte Right_slot
.text "I'm sorry to have worried you, Seadna."
.byte WaitForA
...
.byte NewLine
.text "I don't see Gerald among them."
.byte NewLine
.text "Milord, is she...?"
.byte WaitForA
...
.byte Left_slot
.byte ScrollText
.text "Gods' breath! Th-That can't be...! Lord Neill..."
.byte NewLine
...
.byte Right_slot
.byte ScrollText
.text "You've nothing to apologize for, Seadna."
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "So, Seadna... I'm giving you an order: don't die."
.byte NewLine
...
.byte WaitForA
.byte ScrollText
.text "Very well... Seadna, let's head for the castle and"
.byte NewLine
...
.byte Left_slot
.byte ScrollText
.text "I'm fine. Gerald was there to...to protect me..."
.byte WaitForA
...
.word $0706 ;y then x
.byte NewLine
.text "Neill managed to escape Munster."
.byte WaitForA
.byte ScrollText
...
.byte NewLine
.text "had doggedly pursued Neill, "
.byte WaitForA
.byte NewLine
