...
.byte WaitForA
.byte ScrollText
.text "Pitfighters, meet Gerald. Gerald, pitfighters."
.byte NewLine
...
.byte NewLine
.text "Tell me, is she all that you remembered, Gerald?"
.byte WaitForA
...
.word LoadPortrait
.word guard_portrait
.text "...What about Seadna's little brat?"
.byte WaitForA
...
.word LoadPortrait
.word nanna_portrait
.text "L-Lord Neill! Please, you have to help Gerald!"
.byte NewLine
...
.text "No! Gods, NO!"
.byte NewLine
.text "Commander! Commander Gerald!"
.byte WaitForA
.byte ScrollText
