  ...
  ; Freespace inclusions
    ...
    .section VanillaChapterTalkTableSection
        ...
        aChapter4xTalkTargetTable
          ZQOL_TALK_ENTRY Asbel, [Neill]
          ZQOL_TALK_ENTRY Neill, [Asbel]
          ZQOL_TALK_ENTRY Karin, [CedChp4x]
        ZQOL_END_TALK_CHAPTER

        aChapter7TalkTargetTable
          ZQOL_TALK_ENTRY Fee, [Shiva]
          ZQOL_TALK_ENTRY Neill, [Seadna]
          ZQOL_TALK_ENTRY Nanna, [Seadna]
        ZQOL_END_TALK_CHAPTER

        aChapter8TalkTargetTable
          ZQOL_TALK_ENTRY Otto, [Waulter]
          ZQOL_TALK_ENTRY Barra, [Waulter]
        ZQOL_END_TALK_CHAPTER

        aChapter8xTalkTargetTable
          ZQOL_TALK_ENTRY Otto, [Tanya]
          ZQOL_TALK_ENTRY Neill, [Edith]
        ZQOL_END_TALK_CHAPTER

        aChapter9TalkTargetTable
          ZQOL_TALK_ENTRY Neill, [Selphina]
          ZQOL_TALK_ENTRY Selphina, [Seadna]
          ZQOL_TALK_ENTRY Callion, [Selphina]
        ZQOL_END_TALK_CHAPTER

        aChapter11xTalkTargetTable
          ZQOL_TALK_ENTRY Neill, [Olwen]
        ...
        aChapter12xTalkTargetTable
          ...
          ZQOL_TALK_ENTRY Fee, [Tina]
        ZQOL_END_TALK_CHAPTER

        aChapter13TalkTargetTable
          ZQOL_TALK_ENTRY Seadna, [Glade]
          ZQOL_TALK_ENTRY Selphina, [Glade]
          ZQOL_TALK_ENTRY Neill, [Glade]
        ZQOL_END_TALK_CHAPTER

        aChapter15TalkTargetTable
          ZQOL_TALK_ENTRY Neill, [Ilse]
        ...
        aChapter16BTalkTargetTable
          ...
          ZQOL_TALK_ENTRY Neill, [Sara]
        ZQOL_END_TALK_CHAPTER

        aChapter18TalkTargetTable
          ZQOL_TALK_ENTRY Xavier, [Neill]
          ZQOL_TALK_ENTRY Neill, [Xavier]
        ...
        aChapter23TalkTargetTable
          ZQOL_TALK_ENTRY Neill, [CedChp23, Saias]
        ZQOL_END_TALK_CHAPTER
        ...
        aChapter24xTalkTargetTable
          ZQOL_TALK_ENTRY Neill, [Gerald]
          ZQOL_TALK_ENTRY Mareeta, [Gerald]
        ZQOL_END_TALK_CHAPTER
